...
from update_alert import Ui_Dialog as update_alert
		...
		if keyword != "":
			...
			if dict_result != False:
				...
				if user_acting == QtWidgets.QDialog.Accepted:
					...
					thr_search = threading.Thread(target=twidty.search, 
											args=(keyword, self.date_start.text(), self.date_stop.text(), ))
					thr_search.start()
